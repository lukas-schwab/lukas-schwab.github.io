...
const translations = {
    en: {
        ...
        landing: {
            ...
            card0Text: 'To better understand how artificial neural networks work when processing images, we extract visual concepts from their internal decision-making. To determine how useful these concepts are, we can use established technical metrics. In this study we investigate whether these metrics align with human perception.',
    ...
    de: {
        ...
        landing: {
            ...
            card0Text: 'Um besser zu verstehen, wie künstliche neuronale Netze bei der Bildverarbeitung funktionieren, extrahieren wir visuelle Konzepte aus ihren internen Entscheidungsprozessen. Um festzustellen, wie nützlich diese Konzepte sind, können wir etablierte technische Metriken verwenden. In dieser Studie untersuchen wir, ob diese Metriken mit der menschlichen Wahrnehmung übereinstimmen.',
